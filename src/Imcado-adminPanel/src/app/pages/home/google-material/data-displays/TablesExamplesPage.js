...
const rows = [
  createData("future 2", 159, 6.0, 24, 4.0),
  createData("future 1", 237, 9.0, 37, 4.3),
  createData("example 9", 262, 16.0, 24, 6.0),
  createData("Your first event", 305, 3.7, 67, 4.3),
  createData("Test Event 1 xxxy1123", 356, 16.0, 49, 3.9)
];
...
const rows5 = [
  createData5("future 2", 305, 3.7),
  createData5("future 1", 452, 25.0),
  createData5("example 9", 262, 16.0),
  createData5("example 8", 159, 6.0),
  createData5("Your first event", 356, 16.0),
  createData5("Test Event 1 xxxy1123	", 408, 3.2),
  createData5("Some very old event 1", 237, 9.0),
