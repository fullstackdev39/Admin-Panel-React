...
export const actionTypes = {
  ...
  SetDashboardConfigs: "builder/SET_DASHBOARD_CONFIGS",
};
...
export const reducer = persistReducer(
  ...
  (state = initialState, { type, payload }) => {
    switch (type) {
      ...
      case actionTypes.SetDashboardConfigs:
        return { ...state, dashboardConfig: payload };
      default:
        return state;
    }
  }
...
export const actions = {
  ...
  setDashboardConfig: payload => ({ 
    payload, 
    type: actionTypes.SetDashboardConfigs 
  }),
